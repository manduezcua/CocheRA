...
public class CarBehaviour : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        var Cube = other.GetComponent<CubeBehaviour>();
        if (Package != null)
        {
            Destroy(other.gameObject);
            puntuacion = GameObject.Find("ControlPuntuacion");
            puntuacion.GetComponent<Puntuacion>().SumarPuntaucion();
        }
        if (Cube != null)
        {
            Destroy(other.gameObject);
            puntuacion = GameObject.Find("ControlPuntuacion");
            puntuacion.GetComponent<Puntuacion>().Resetear();
        }
    }
}
